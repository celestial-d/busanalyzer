...
// added capture scsi commands, added capture NVMe commands
const QEMULogItem qemu_log_items[] = {
    { CPU_LOG_TB_SCSI_CMD, "scsi_cmd",
      "show generated scsi commands" },
    { CPU_LOG_TB_NVMe_CMD, "nvme_cmd",
      "show generated nvme commands" },
